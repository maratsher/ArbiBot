...
SETTINGS_INFO = ('Основная монета: <b>Tether (USDT)</b>\n'
                 'Целевая монета: <b>{target_coin_name}</b>\n\n'
                 'Объем закупки: <b>{init_volume}</b>\n'
                 'Объем торгов: <b>{volume}</b>\n'
                 'Порог: <b>{threshold} USDT</b>\n'
                 'Погрешность: <b>{epsilon} USDT</b>\n'
                 'Время ордера: <b>{wait_order_minutes}</b>'
                 '{auto_info_text}')
SETTINGS_BASE_COIN = 'Выберите новую монету'
SETTINGS_INIT_VOLUME = 'Введите новый объем закупки'
